...
export default function SignupModal({
  ...
  const { signupUser, signInWithGoogle } = useApp();
              ...
              <div className="md:col-span-7 space-y-4">
                ...
                <div className="space-y-2.5">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-100 border border-gray-300 dark:border-gray-600 rounded-xl py-3 px-4 text-xs font-bold transition-all shadow-sm hover:scale-[1.01] active:scale-[0.99]"
                  ...
                  <div className="relative flex items-center justify-center my-2">
                    ...
                    <span className="bg-[var(--color-paper)] dark:bg-[var(--color-ink)] px-2.5 text-[10px] uppercase font-bold text-gray-400 shrink-0">
                      Or register with phone details
                    </span>
                  </div>
                </div>
